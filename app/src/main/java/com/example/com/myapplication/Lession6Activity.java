...
public class Lession6Activity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        NewwordFragment nf = new NewwordFragment(6);
        adapter.addFragment(nf, "新言葉");
        adapter.addFragment(new ListenFragment(6), "聴解");
        adapter.addFragment(new VocabFragment(6), "文法");
        adapter.addFragment(new TestFragment(6), "試験");
