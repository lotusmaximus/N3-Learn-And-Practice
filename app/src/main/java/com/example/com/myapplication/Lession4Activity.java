...
public class Lession4Activity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        NewwordFragment nf = new NewwordFragment(4);
        adapter.addFragment(nf, "新言葉");
        adapter.addFragment(new ListenFragment(4), "聴解");
        adapter.addFragment(new VocabFragment(4), "文法");
        adapter.addFragment(new TestFragment(4), "試験");
