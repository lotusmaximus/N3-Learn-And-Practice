...
public class Lession3Activity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        NewwordFragment nf = new NewwordFragment(3);
        adapter.addFragment(nf, "新言葉");
        adapter.addFragment(new ListenFragment(3), "聴解");
        adapter.addFragment(new VocabFragment(3), "文法");
        adapter.addFragment(new TestFragment(3), "試験");
