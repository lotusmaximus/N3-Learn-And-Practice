...
public class Lession1Activity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new NewwordFragment(1), "新言葉");
        adapter.addFragment(new ListenFragment(1), "聴解");
        adapter.addFragment(new VocabFragment(1), "文法");
        adapter.addFragment(new TestFragment(1), "試験");
