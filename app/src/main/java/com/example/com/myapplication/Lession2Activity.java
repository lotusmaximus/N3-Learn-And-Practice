...
public class Lession2Activity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        NewwordFragment nf = new NewwordFragment(2);
        adapter.addFragment(nf, "新言葉");

        adapter.addFragment(new ListenFragment(2), "聴解");
        adapter.addFragment(new VocabFragment(2), "文法");
        adapter.addFragment(new TestFragment(2), "試験");
