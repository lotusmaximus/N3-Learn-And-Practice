...
public class Lession8Activity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new NewwordFragment(8), "新言葉");
        adapter.addFragment(new ListenFragment(8), "聴解");
        adapter.addFragment(new VocabFragment(8), "文法");
        adapter.addFragment(new TestFragment(8), "試験");
