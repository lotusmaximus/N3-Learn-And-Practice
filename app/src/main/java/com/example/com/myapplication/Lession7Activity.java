...
public class Lession7Activity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        NewwordFragment nf = new NewwordFragment(7);
        adapter.addFragment(nf, "新言葉");
        adapter.addFragment(new ListenFragment(7), "聴解");
        adapter.addFragment(new VocabFragment(7), "文法");
        adapter.addFragment(new TestFragment(7), "試験");
